...
<a href="/my_resume.pdf" download={resumePdf.original_filename} className="resume-link">
  <Download /> Download resume
        ...
        <div className="hero-metrics"><div><strong><Counter value={1} suffix=".3" /></strong><span>Years building</span></div><div><strong><Counter value={4} suffix="+" /></strong><span>Business products</span></div><div><strong><Counter value={7} suffix="+" /></strong><span>Core technologies</span></div><div><strong>Full-cycle</strong><span>Product delivery</span></div></div>
      </section>
